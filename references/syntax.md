...
## ПАТТЕРН: Из ТЗ → Activity Diagram

Когда пользователь даёт ТЗ с нумерованными пунктами, преобразуй по правилам:

| Структура в ТЗ | Конструкция PlantUML |
|----------------|----------------------|
| `1.1`, `1.2`, `1.3` — последовательные | `:шаг;` один за другим |
| `1.2.1`, `1.2.2`, `1.2.3` — вложенные под одним родителем | `if/else if/else/endif` |
| `1.3.1`, `1.3.2`, `1.3.3` — не взаимоисключающие | `fork/fork again/end fork` |
| «выбрать из таблицы», «пролистываем до выбора» | `repeat/while` |
| «Экспорт», «да/нет» | `if/else/endif` |
...
if (Боковина?) then (Стандартная)
  :Стандартные боковины;
else (Стыковочная)
  :Стыковочные боковины;
endif
